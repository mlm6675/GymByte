...
CREATE TABLE `score` (
  ...
  CONSTRAINT `score_ibfk_1` FOREIGN KEY (`GymnastID`) REFERENCES `gymnast` (`GymnastID`),
  CONSTRAINT `score_ibfk_2` FOREIGN KEY (`UserID`) REFERENCES `user` (`UserID`),
  CONSTRAINT `score_ibfk_3` FOREIGN KEY (`RotationID`) REFERENCES `rotation` (`RotationID`)
